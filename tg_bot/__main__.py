...
എന്നെ നിർമ്മിച്ചിരിക്കുന്നത് python3 യിൽ python-telegram-bot ലൈബ്രറി ഉപയോഗിച്ചാണ്. ഞാൻ പൂർണ്ണമായിട്ടും ഓപ്പൺസോഴ്സ്ഡ് ആണ്. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://t.me/worldmoviesaj) കാണുവാൻ സാധിക്കും.
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),  InlineKeyboardButton(text="🤖 Make Own Admin Bot", url="https://t.me/worldmoviesaj")],
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/AJmovieLINKS"), InlineKeyboardButton(text="MY CREATOR", url="https://t.me/avataradorn")],
                     [InlineKeyboardButton(text="🎬 MOVIE GROUP", url="https://t.me/worldmoviesaj"), InlineKeyboardButton(text="DONT TOUCH💥", url="https://t.me/{}?start=help".format(bot.username)) ]]))
